...
const imageUrls = [
  {
    img: "/realismo1.png",
    texto:
      "'Le déjeuner sur l'herbe' é um óleo sobre tela da autoria de Édouard Manet, pintado entre 1862 e 1863, com as medidas de 208 por 264,5 centímetros.",
  },
  ...
  return (
    <>
      ...
      <p className="texto">
        ...
        reação ao Romantismo. Caracterizou-se pela representação objetiva da
        realidade, abordando a vida cotidiana, questões sociais, políticas e
        econômicas de forma crítica. Na pintura, focou em temas como a classe
        trabalhadora, pobreza e desigualdades, evitando romantização. Gustave
        Courbet se destacou com obras como Os Quebradores de Pedra. Na
        literatura, explorou a psicologia humana e questões sociais, com autores
        notáveis como Gustave Flaubert e Émile Zola. O Realismo surgiu em
        resposta à Revolução Industrial e influenciou movimentos posteriores,
        moldando a cultura moderna.
      </p>
